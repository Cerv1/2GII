...
/** @brief Constructor primitivo de la clase.
	...
	*/
	crimen::crimen(){
		...
		this->Date = vacia;
		this->IUCR = "default";
		this->PrimaryType = "default";
		this->Description = "default";
		this->LocationDescription = "default";
		this->Arrest = false;
		this->Domestic = false;
		this->Latitude = 0.0;
		this->Longitude = 0.0;
...
/** @brief Iguala dos crímenes.
	...
	*/
   	crimen & crimen::operator=(const crimen & c){
		...
		this->LocationDescription = c.LocationDescription;
...
/** @brief Copia en un crimen los datos de otro pasado como string.
	...
	*/
   	crimen & crimen::operator=(const string & datos){
		...
		this->PrimaryType=aux.substr(0,aux.find_first_of(","));
		...
		this->LocationDescription=aux.substr(0,aux.find_first_of(","));
