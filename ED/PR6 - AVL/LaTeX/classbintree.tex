...
Destruye todos los nodos del árbol receptor y lo hace un árbol nulo. \hypertarget{classbintree_ae96f1d4033e009d56cc956e1b05d4208}{}\index{bintree@{bintree}!copy@{copy}}
\index{copy@{copy}!bintree@{bintree}}
\subsubsection[{copy}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ void {\bf bintree}$<$ T $>$\+::copy (
\begin{DoxyParamCaption}
\item[{{\bf node} \&}]{dest, }
\item[{const {\bf node} \&}]{orig}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{classbintree_ae96f1d4033e009d56cc956e1b05d4208}
...
\begin{DoxyParams}{Parámetros}
{\em dest} & nodo sobre el que se copia. dest.\+null(). Es M\+O\+D\+I\+F\+I\+C\+A\+D\+O. \\
\hline
{\em orig} & raíz del subárbol que se copia.\\
\hline
\end{DoxyParams}
Destruye el subárbol con raíz en dest. Sobre éste realiza un duplicado del subárbol con raíz en orig. \hypertarget{classbintree_a67dfc885afb58a86b3356c5b897e98d2}{}\index{bintree@{bintree}!count@{count}}
\index{count@{count}!bintree@{bintree}}
\subsubsection[{count}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ int {\bf bintree}$<$ T $>$\+::count (
\begin{DoxyParamCaption}
\item[{{\bf node}}]{n}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [private]}}\label{classbintree_a67dfc885afb58a86b3356c5b897e98d2}
...
\begin{DoxyParams}{Parámetros}
{\em n} & raíz del subárbol a contar.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
devuelve el número de nodos del subárbol que tiene n como raíz.
\end{DoxyReturn}
Cuenta el número de nodos en el subárbol cuuya raíz es n. \hypertarget{classbintree_a592b7a2273dcdefbf5ca012eba85b84a}{}\index{bintree@{bintree}!destroy@{destroy}}
\index{destroy@{destroy}!bintree@{bintree}}
\subsubsection[{destroy}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ void {\bf bintree}$<$ T $>$\+::destroy (
\begin{DoxyParamCaption}
\item[{{\bf bintree}$<$ T $>$\+::{\bf node}}]{n}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{classbintree_a592b7a2273dcdefbf5ca012eba85b84a}
...
\begin{DoxyParams}{Parámetros}
{\em n} & nodo raíz del subárbol que se destruye. \+: Destruye el subárbol cuya raíz es n. \\
\hline
\end{DoxyParams}
\hypertarget{classbintree_a772126c3e8b7cd37e5a93ccbda01f8dd}{}\index{bintree@{bintree}!empty@{empty}}
...
\end{DoxyReturn}
\hypertarget{classbintree_a6a7491790f1fe7b107283182e02b68bc}{}\index{bintree@{bintree}!equals@{equals}}
\index{equals@{equals}!bintree@{bintree}}
\subsubsection[{equals}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ bool {\bf bintree}$<$ T $>$\+::equals (
\begin{DoxyParamCaption}
\item[{{\bf node}}]{n1, }
\item[{{\bf node}}]{n2}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [private]}}\label{classbintree_a6a7491790f1fe7b107283182e02b68bc}
...
\begin{DoxyParams}{Parámetros}
{\em n1} & raiz del primer subárbol. \\
\hline
{\em n2} & raiz del segundo subárbol.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
true, si los dos subárboles son iguales, en estructura y etiquetas. false, en otro caso. 
\end{DoxyReturn}
